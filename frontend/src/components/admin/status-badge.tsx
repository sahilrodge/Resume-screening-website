...
const toneMap: Record<string, string> = {
  ...
  "Interview Scheduled": "bg-sky-500/15 text-sky-700 dark:text-sky-300",
  "Interview Completed": "bg-teal-500/15 text-teal-800 dark:text-teal-300",
  interview: "bg-sky-500/15 text-sky-700 dark:text-sky-300",
  interview_completed: "bg-teal-500/15 text-teal-800 dark:text-teal-300",
  Offered: "bg-violet-500/15 text-violet-700 dark:text-violet-300",
  offered: "bg-violet-500/15 text-violet-700 dark:text-violet-300",
